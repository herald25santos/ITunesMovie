...
import com.appetiser.data.util.DispatchersProviderImpl
import com.appetiser.itunesmovie.common.util.NetworkMonitor
import com.appetiser.itunesmovie.common.util.ResourceProvider
...
class AppModule {
    ...
    fun provideAppSettingsSharedPreference(
        @ApplicationContext
        context: Context
    ): SharedPreferences {
