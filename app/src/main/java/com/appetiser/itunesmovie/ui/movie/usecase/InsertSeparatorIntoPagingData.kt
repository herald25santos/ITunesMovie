...
class InsertSeparatorIntoPagingData @Inject constructor() {
    ...
    private fun isDifferentCategory(
        before: MovieListItem.Movie?,
        after: MovieListItem.Movie?
    ): Boolean =
     ...
     * **/
    private fun insertHeaderItem(after: MovieListItem.Movie?): MovieListItem? =
        createSeparator(after)
     ...
     * **/
    private fun insertSeparatorItem(after: MovieListItem.Movie?): MovieListItem.Separator? =
        createSeparator(after)
